...
> Les images ci-dessous sont servies depuis `public/assets/images/projects/`. Cette liste regroupe uniquement les réalisations retenues comme projets livrés, publiés ou démontrables ; les travaux encore en préparation sont volontairement exclus.

| # | Projet | Visuel | Problème traité | Solution | Résultat / statut | Stack | Lien |
|---|---|---|---|---|---|---|---|
| 1 | **ShopCI**<br>Marketplace multi-vendeurs, fiabilité & visibilité pour le e-commerce local ivoirien | <img src="./public/assets/images/projects/shopci-responsive.webp" alt="Aperçu ShopCI" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | React, Django, Bootstrap 5, Vercel + PythonAnywhere | [shop-ci.vercel.app](https://shop-ci.vercel.app/) *(repo privé)* |
| 2 | **TechFlow**<br>Site vitrine one-page, rapide et orienté conversion | <img src="./public/assets/images/projects/techflow.webp" alt="Aperçu TechFlow" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | HTML/Tailwind CSS, JavaScript, Vercel | [techflow-ten.vercel.app](https://techflow-ten.vercel.app/) |
| 3 | **TerraSafe**<br>Marketplace foncière avec recherche avancée et approche anti-arnaque | <img src="./public/assets/images/projects/terrasafe.webp" alt="Aperçu TerraSafe" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | Python/Flask, MySQL, Bootstrap 5 | [wthomassss06.pythonanywhere.com](https://wthomassss06.pythonanywhere.com) |
| 4 | **Chap-chapMAP**<br>Cartographie intelligente, géolocalisation et itinéraires | <img src="./public/assets/images/projects/chapchapmap.webp" alt="Aperçu Chap-chapMAP" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | JavaScript, Leaflet.js, OSRM API, Geolocation API | Démo intégrée (`/demos/chap-chapMAP.html`) |
| 5 | **ElvisMarket**<br>Interface e-commerce : état, panier dynamique et expérience d’achat | <img src="./public/assets/images/projects/elvismarket.webp" alt="Aperçu ElvisMarket" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | HTML/JS vanilla, Tailwind CSS, LocalStorage | Démo intégrée (`/demos/projet2.html`) |
| 6 | **MonCashJour**<br>Suivi de ventes quotidiennes pour petits commerçants | <img src="./public/assets/images/projects/moncashjour.webp" alt="Aperçu MonCashJour" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | HTML/JS vanilla, Tailwind CSS, Chart.js | Démo intégrée (`/demos/projet1.html`) |
| 7 | **LivreurTrack Pro**<br>Workflow logistique avec preuve photo et statuts de livraison | <img src="./public/assets/images/projects/livreurtrack.webp" alt="Aperçu LivreurTrack Pro" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | JavaScript, Bootstrap 5, LocalStorage, Camera API | Démo intégrée (`/demos/projet3.html`) |
| 9 | **Tati**<br>Portfolio personnel double fonction avec thème clair/sombre | <img src="./public/assets/images/projects/tati.webp" alt="Aperçu Tati" width="180" /> | Voir `portfolioData.js` | Voir `portfolioData.js` | Voir `portfolioData.js` | React, Tailwind CSS, Framer Motion, Vercel | [tatii.vercel.app](https://tatii.vercel.app/) |
