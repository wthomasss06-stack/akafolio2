...
import LuxuryAction, { CyclicText, getAkatechCycle } from '../components/LuxuryAction'
    ...
    <div className="container section">
      ...
      <div className="grid-2" style={{ alignItems: 'start' }}>
        ...
        <div>
          ...
          <div ref={linksRef} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '3rem' }}>
            {[
              ...
              >
                <CyclicText text={link.label} cycle={getAkatechCycle(link.label)} triggerParent />
                <span style={{ color: 'var(--text)' }}>{link.value}</span>
              </a>
            ))}
          </div>

          <LuxuryAction as="a" label="Télécharger mon CV" href={CONTACT.cv} target="_blank" rel="noreferrer" />
        </div>
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <LuxuryAction
                ...
                disabled={sending}
                label={btnTxt}
                style={{ width: '100%', justifyContent: 'center', opacity: sending ? 0.7 : 1, cursor: sending ? 'default' : 'pointer' }}
              />
