...
// Instancié à la demande (dans POST), pas au chargement du module : le SDK
// Resend lève une erreur immédiate si la clé est absente, ce qui ferait
// échouer `next build` (Next.js évalue les routes API pendant le build,
// contrairement à l'ancienne Vercel Function autonome qui n'était jamais
// chargée avant le runtime réel). Aucun changement de comportement pour
...
/* ════════════════════════════════════════════
   ...
   Même logique qu'avant (api/contact.js Vercel) —
   seule la signature req/res a changé pour le
   format Route Handler de Next.js.
   ════════════════════════════════════════════ */
