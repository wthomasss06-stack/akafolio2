...
// Next.js (Turbopack/webpack) n'a pas de loader intégré pour importer un
// .wav comme un module JS (Vite, lui, gère ça nativement). On sert le
// fichier depuis public/ à la place — même résultat pour new Audio(...),
// juste un chemin public plutôt qu'une URL générée par le bundler.
const immersionTrack = '/assets/sound/immersion-loop.wav'
